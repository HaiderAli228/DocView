...
class _IntroScreenState extends State<IntroScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          IntroductionScreen(
            pages: _getPageViews(size),
            onDone: _navigateToHome,
            onSkip: _navigateToHome,
            showSkipButton: false,
            next: _buildButton(icon: Icons.arrow_forward),
            done: const SizedBox.shrink(),
            dotsDecorator: _getDotsDecorator(size),
          ),
  ...
  List<PageViewModel> _getPageViews(Size size) {
    return [
      PageViewModel(
        titleWidget: _buildTitle("AI-Powered Study Companion", "DocView", size),
        ...
        image: _buildImage('assets/images/first.json', size),
        decoration: _getPageDecoration(size),
      ),
      PageViewModel(
        titleWidget: _buildTitle("Document Scanning with", " DocView", size),
        bodyWidget: _buildBody(
        ...
        image: _buildImage('assets/images/scanning.json', size),
        decoration: _getPageDecoration(size),
      ),
      PageViewModel(
        titleWidget:
            _buildTitle("Quick Access to Past Papers in ", "DocView", size),
        bodyWidget: Column(
        ...
        image: _buildImage('assets/images/search.json', size),
        decoration: _getPageDecoration(size),
      ),
    ];
  }
  ...
  void _navigateToHome() {
    Navigator.of(context).pushReplacementNamed(RoutesName.homeScreenView);
  }

  Positioned _buildSkipButton(Size size) {
    return Positioned(
  ...
  Widget _buildTitle(String title1, String title2, Size size) {
    return Padding(
  ...
  Widget _buildBody(String body, Size size) {
    return Padding(
  ...
  PageDecoration _getPageDecoration(Size size) {
  ...
  DotsDecorator _getDotsDecorator(Size size) {
